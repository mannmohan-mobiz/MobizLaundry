...
class ServiceCompletedOrderDetailsModel {
  bool status;
  ServiceCompletedOrderDetailData data;
  String message;

  ServiceCompletedOrderDetailsModel({
    required this.status,
    required this.data,
    required this.message,
  });

  ServiceCompletedOrderDetailsModel copyWith({
    bool? status,
    ServiceCompletedOrderDetailData? data,
    String? message,
  }) =>
  ...
  factory ServiceCompletedOrderDetailsModel.fromRawJson(String str) => ServiceCompletedOrderDetailsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ServiceCompletedOrderDetailsModel.fromJson(Map<String, dynamic> json) => ServiceCompletedOrderDetailsModel(
    status: json["status"],
    data: ServiceCompletedOrderDetailData.fromJson(json["data"]),
...
class ServiceCompletedOrderDetailData {
  Order order;
  List<Cart> cart;

  ServiceCompletedOrderDetailData({
    required this.order,
    required this.cart,
  });

  ServiceCompletedOrderDetailData copyWith({
    Order? order,
    List<Cart>? cart,
  }) =>
      ServiceCompletedOrderDetailData(
  ...
  factory ServiceCompletedOrderDetailData.fromRawJson(String str) => ServiceCompletedOrderDetailData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ServiceCompletedOrderDetailData.fromJson(Map<String, dynamic> json) => ServiceCompletedOrderDetailData(
