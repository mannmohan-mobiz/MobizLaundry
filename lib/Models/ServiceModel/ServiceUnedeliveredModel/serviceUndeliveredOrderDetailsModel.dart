...
class ServiceUndeliveredDetailsModel {
  bool status;
  ServiceUndeliveredDetailsData data;
  String message;

  ServiceUndeliveredDetailsModel({
    required this.status,
    required this.data,
    required this.message,
  });

  ServiceUndeliveredDetailsModel copyWith({
    bool? status,
    ServiceUndeliveredDetailsData? data,
    String? message,
  }) =>
  ...
  factory ServiceUndeliveredDetailsModel.fromRawJson(String str) => ServiceUndeliveredDetailsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ServiceUndeliveredDetailsModel.fromJson(Map<String, dynamic> json) => ServiceUndeliveredDetailsModel(
    status: json["status"],
    data: ServiceUndeliveredDetailsData.fromJson(json["data"]),
...
class ServiceUndeliveredDetailsData {
  Order order;
  List<Cart> cart;

  ServiceUndeliveredDetailsData({
    required this.order,
    required this.cart,
  });

  ServiceUndeliveredDetailsData copyWith({
    Order? order,
    List<Cart>? cart,
  }) =>
      ServiceUndeliveredDetailsData(
  ...
  factory ServiceUndeliveredDetailsData.fromRawJson(String str) => ServiceUndeliveredDetailsData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ServiceUndeliveredDetailsData.fromJson(Map<String, dynamic> json) => ServiceUndeliveredDetailsData(
