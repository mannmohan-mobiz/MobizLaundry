...
class ServiceReadyToDeliverDetailsModel {
  bool status;
  ServiceReadytoDeliverDetailsData data;
  String message;

  ServiceReadyToDeliverDetailsModel({
    required this.status,
    required this.data,
    required this.message,
  });

  ServiceReadyToDeliverDetailsModel copyWith({
    bool? status,
    ServiceReadytoDeliverDetailsData? data,
    String? message,
  }) =>
  ...
  factory ServiceReadyToDeliverDetailsModel.fromRawJson(String str) => ServiceReadyToDeliverDetailsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ServiceReadyToDeliverDetailsModel.fromJson(Map<String, dynamic> json) => ServiceReadyToDeliverDetailsModel(
    status: json["status"],
    data: ServiceReadytoDeliverDetailsData.fromJson(json["data"]),
...
class ServiceReadytoDeliverDetailsData {
  Order order;
  List<Cart> cart;

  ServiceReadytoDeliverDetailsData({
    required this.order,
    required this.cart,
  });

  ServiceReadytoDeliverDetailsData copyWith({
    Order? order,
    List<Cart>? cart,
  }) =>
      ServiceReadytoDeliverDetailsData(
  ...
  factory ServiceReadytoDeliverDetailsData.fromRawJson(String str) => ServiceReadytoDeliverDetailsData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ServiceReadytoDeliverDetailsData.fromJson(Map<String, dynamic> json) => ServiceReadytoDeliverDetailsData(
